...
@interface ThemeIOSLargeSize ()

@end

@implementation ThemeIOSLargeSize

- (instancetype)init
{
    self = [super init];

    self.menuLocalIcon = [imageManager get:ImageIcon_LocalMenuDefault_Large];
    self.menuGlobalIcon = [imageManager get:ImageIcon_GlobalMenuDefault_Large];
