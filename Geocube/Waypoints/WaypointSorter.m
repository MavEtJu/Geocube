...
#define CASE(__order__, __title__) \
    case __order__: \
        ...
        break;
        switch (i) {
            CASE(SORTORDERWP_DISTANCE_ASC, _(@"waypointsorter-Distance (ascending)"))
            CASE(SORTORDERWP_DISTANCE_DESC, _(@"waypointsorter-Distance (descending)"))
            CASE(SORTORDERWP_DIRECTION_ASC, _(@"waypointsorter-Direction (ascending)"))
            CASE(SORTORDERWP_DIRECTION_DESC, _(@"waypointsorter-Direction (descending)"))
            CASE(SORTORDERWP_TYPE, _(@"waypointsorter-Type"))
            CASE(SORTORDERWP_CONTAINER, _(@"waypointsorter-Container"))
            CASE(SORTORDERWP_FAVOURITES_ASC, _(@"waypointsorter-Favourites (ascending)"))
            CASE(SORTORDERWP_FAVOURITES_DESC, _(@"waypointsorter-Favourites (descending)"))
            CASE(SORTORDERWP_TERRAIN_ASC, _(@"waypointsorter-Terrain (ascending)"))
            CASE(SORTORDERWP_TERRAIN_DESC, _(@"waypointsorter-Terrain (descending)"))
            CASE(SORTORDERWP_DIFFICULTY_ASC, _(@"waypointsorter-Difficulty (ascending)"))
            CASE(SORTORDERWP_DIFFICULTY_DESC, _(@"waypointsorter-Difficulty (descending)"))
            CASE(SORTORDERWP_NAME_ASC, _(@"waypointsorter-Name (ascending)"))
            CASE(SORTORDERWP_NAME_DESC, _(@"waypointsorter-Name (descending)"))
            CASE(SORTORDERWP_CODE_ASC, _(@"waypointsorter-Code (ascending)"))
            CASE(SORTORDERWP_CODE_DESC, _(@"waypointsorter-Code (descending)"))
            CASE(SORTORDERWP_DATE_LASTLOG_OLDESTFIRST, _(@"waypointsorter-Last log date (oldest first)"))
            CASE(SORTORDERWP_DATE_LASTLOG_NEWESTFIRST, _(@"waypointsorter-Last log date (newest first)"))
            CASE(SORTORDERWP_DATE_HIDDEN_OLDESTFIRST, _(@"waypointsorter-Hidden date (oldest first)"))
            CASE(SORTORDERWP_DATE_HIDDEN_NEWESTFIRST, _(@"waypointsorter-Hidden date (newest first)"))
            CASE(SORTORDERWP_DATE_FOUND_OLDESTFIRST, _(@"waypointsorter-Found date (oldest first)"))
            CASE(SORTORDERWP_DATE_FOUND_NEWESTFIRST, _(@"waypointsorter-Found date (newest first)"))
            default:
                NSAssert(NO, @"Unknown sort order");
        }
    }
...
#define CASE(__order__, __title__) \
    case __order__: \
        ...
        break;
        switch (i) {
            CASE(SORTORDERLOCATIONLESS_NAME_ASC, _(@"waypointsorter-Name (ascending)"))
            CASE(SORTORDERLOCATIONLESS_NAME_DESC, _(@"waypointsorter-Name (descending)"))
            CASE(SORTORDERLOCATIONLESS_CODE_ASC, _(@"waypointsorter-Code (ascending)"))
            CASE(SORTORDERLOCATIONLESS_CODE_DESC, _(@"waypointsorter-Code (descending)"))
            CASE(SORTORDERLOCATIONLESS_DATE_LASTLOG_OLDESTFIRST, _(@"waypointsorter-Last log date (oldest first)"))
            CASE(SORTORDERLOCATIONLESS_DATE_LASTLOG_NEWESTFIRST, _(@"waypointsorter-Last log date (newest first)"))
            CASE(SORTORDERLOCATIONLESS_DATE_HIDDEN_OLDESTFIRST, _(@"waypointsorter-Hidden date (oldest first)"))
            CASE(SORTORDERLOCATIONLESS_DATE_HIDDEN_NEWESTFIRST, _(@"waypointsorter-Hidden date (newest first)"))
            CASE(SORTORDERLOCATIONLESS_DATE_FOUND_OLDESTFIRST, _(@"waypointsorter-Found date (oldest first)"))
            CASE(SORTORDERLOCATIONLESS_DATE_FOUND_NEWESTFIRST, _(@"waypointsorter-Found date (newest first)"))
            default:
                NSAssert(NO, @"Unknown sort order");
        }
    }
...
#define CASE(__order__, __title__) \
    case __order__: \
        ...
        break;
        switch (i) {
            CASE(SORTORDERLIST_TIMEADDED_ASC, _(@"waypointsorter-Time added (ascending)"))
            CASE(SORTORDERLIST_TIMEADDED_DESC, _(@"waypointsorter-Time added (descending)"))
            CASE(SORTORDERLIST_DISTANCE_ASC, _(@"waypointsorter-Distance (ascending)"))
            CASE(SORTORDERLIST_DISTANCE_DESC, _(@"waypointsorter-Distance (descending)"))
            CASE(SORTORDERLIST_DIRECTION_ASC, _(@"waypointsorter-Direction (ascending)"))
            CASE(SORTORDERLIST_DIRECTION_DESC, _(@"waypointsorter-Direction (descending)"))
            CASE(SORTORDERLIST_TYPE, _(@"waypointsorter-Type"))
            CASE(SORTORDERLIST_CONTAINER, _(@"waypointsorter-Container"))
            CASE(SORTORDERLIST_FAVOURITES_ASC, _(@"waypointsorter-Favourites (ascending)"))
            CASE(SORTORDERLIST_FAVOURITES_DESC, _(@"waypointsorter-Favourites (descending)"))
            CASE(SORTORDERLIST_TERRAIN_ASC, _(@"waypointsorter-Terrain (ascending)"))
            CASE(SORTORDERLIST_TERRAIN_DESC, _(@"waypointsorter-Terrain (descending)"))
            CASE(SORTORDERLIST_DIFFICULTY_ASC, _(@"waypointsorter-Difficulty (ascending)"))
            CASE(SORTORDERLIST_DIFFICULTY_DESC, _(@"waypointsorter-Difficulty (descending)"))
            CASE(SORTORDERLIST_NAME_ASC, _(@"waypointsorter-Name (ascending)"))
            CASE(SORTORDERLIST_NAME_DESC, _(@"waypointsorter-Name (descending)"))
            CASE(SORTORDERLIST_CODE_ASC, _(@"waypointsorter-Code (ascending)"))
            CASE(SORTORDERLIST_CODE_DESC, _(@"waypointsorter-Code (descending)"))
            CASE(SORTORDERLIST_DATE_LASTLOG_OLDESTFIRST, _(@"waypointsorter-Last log date (oldest first)"))
            CASE(SORTORDERLIST_DATE_LASTLOG_NEWESTFIRST, _(@"waypointsorter-Last log date (newest first)"))
            CASE(SORTORDERLIST_DATE_HIDDEN_OLDESTFIRST, _(@"waypointsorter-Hidden date (oldest first)"))
            CASE(SORTORDERLIST_DATE_HIDDEN_NEWESTFIRST, _(@"waypointsorter-Hidden date (newest first)"))
            CASE(SORTORDERLIST_DATE_FOUND_OLDESTFIRST, _(@"waypointsorter-Found date (oldest first)"))
            CASE(SORTORDERLIST_DATE_FOUND_NEWESTFIRST, _(@"waypointsorter-Found date (newest first)"))
            default:
                NSAssert(NO, @"Unknown sort order");
        }
    }
