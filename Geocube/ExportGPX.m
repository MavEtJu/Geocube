...
+ (void)export:(dbWaypoint *)wp
{
    ...
    [e waypoint:wp];
    [e trailer];
    [e writeToFile:[NSString stringWithFormat:@"Export - %@.gpx", [MyTools dateTimeString:time(NULL)]]];
}
...
- (void)header
{
    ...
    LINE_S(@"time", [MyTools dateTimeString:time(NULL)]);
