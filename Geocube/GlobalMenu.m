...
{
    self = [super init];
    items = [NSArray arrayWithObjects:@"Navigate", @"-Caches Online", @"Caches Offline", @"Notes and Logs", @"Trackables", @"Groups", @"Browser", @"Files", @"User Profile", @"Notices", @"Settings", @"Help", nil];
