...
{
    self = [super init];
    items = [NSArray arrayWithObjects:@"Navigate", @"XCaches Online", @"Caches Offline", @"Notes and Logs", @"Trackables", @"Groups", @"Browser", @"Files", @"User Profile", @"Notices", @"Settings", @"Help", @"Keep track", nil];
