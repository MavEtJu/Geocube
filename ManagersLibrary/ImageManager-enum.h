...
typedef NS_ENUM(NSInteger, ImageNumber) {
    ...
    ImageIcon_GlobalMenuDefault_Large,
    ImageIcon_LocalMenuDefault_Large,
    ImageIcon_GlobalMenuNight_Large,
    ImageIcon_LocalMenuNight_Large,
    ImageIcon_CloseButton_Large,
    ImageIcon_ShowBoth_Large,
    ImageIcon_SeeTarget_Large,
    ImageIcon_FollowMe_Large,
    ImageIcon_FindMe_Large,
    ImageIcon_FindTarget_Large,
    ImageIcon_GNSSOn_Large,
    ImageIcon_GNSSOff_Large,
