...
typedef NS_ENUM(NSInteger, ImageNumber) {
    ...
    ImageIcon_GlobalMenuDefault_Normal,
    ImageIcon_LocalMenuDefault_Normal,
    ImageIcon_GlobalMenuNight_Normal,
    ImageIcon_LocalMenuNight_Normal,
    ImageIcon_CloseButton_Normal,
    ImageIcon_ShowBoth_Normal,
    ImageIcon_SeeTarget_Normal,
    ImageIcon_FollowMe_Normal,
    ImageIcon_FindMe_Normal,
    ImageIcon_FindTarget_Normal,
    ImageIcon_GNSSOn_Normal,
    ImageIcon_GNSSOff_Normal,

    ImageIcon_GlobalMenuDefault_Small,
    ImageIcon_LocalMenuDefault_Small,
    ImageIcon_GlobalMenuNight_Small,
    ImageIcon_LocalMenuNight_Small,
    ImageIcon_CloseButton_Small,
    ImageIcon_ShowBoth_Small,
    ImageIcon_SeeTarget_Small,
    ImageIcon_FollowMe_Small,
    ImageIcon_FindMe_Small,
    ImageIcon_FindTarget_Small,
    ImageIcon_GNSSOn_Small,
    ImageIcon_GNSSOff_Small,
