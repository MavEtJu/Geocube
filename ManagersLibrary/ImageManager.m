...
- (instancetype)init
{
    ...
    [self addToLibrary:@"menu icon - global default - 27x27" index:ImageIcon_GlobalMenuDefault_Normal];
    [self addToLibrary:@"menu icon - local default - 27x27" index:ImageIcon_LocalMenuDefault_Normal];
    [self addToLibrary:@"menu icon - global night - 27x27" index:ImageIcon_GlobalMenuNight_Normal];
    [self addToLibrary:@"menu icon - local night - 27x27" index:ImageIcon_LocalMenuNight_Normal];
    [self addToLibrary:@"menu icon - close - 15x15" index:ImageIcon_CloseButton_Normal];
    [self addToLibrary:@"menu icon - see target - 27x27" index:ImageIcon_SeeTarget_Normal];
    [self addToLibrary:@"menu icon - show both - 27x27" index:ImageIcon_ShowBoth_Normal];
    [self addToLibrary:@"menu icon - follow me - 27x27" index:ImageIcon_FollowMe_Normal];
    [self addToLibrary:@"menu icon - find me - 27x27" index:ImageIcon_FindMe_Normal];
    [self addToLibrary:@"menu icon - find target - 27x27" index:ImageIcon_FindTarget_Normal];
    [self addToLibrary:@"menu icon - gnss-on - 27x27" index:ImageIcon_GNSSOn_Normal];
    [self addToLibrary:@"menu icon - gnss-off - 27x27" index:ImageIcon_GNSSOff_Normal];

    [self addToLibrary:@"menu icon - global default - 40x40" index:ImageIcon_GlobalMenuDefault_Large];
    [self addToLibrary:@"menu icon - local default - 40x40" index:ImageIcon_LocalMenuDefault_Large];
    [self addToLibrary:@"menu icon - global night - 40x40" index:ImageIcon_GlobalMenuNight_Large];
    [self addToLibrary:@"menu icon - local night - 40x40" index:ImageIcon_LocalMenuNight_Large];
    [self addToLibrary:@"menu icon - close - 30x30" index:ImageIcon_CloseButton_Large];
    [self addToLibrary:@"menu icon - see target - 40x40" index:ImageIcon_SeeTarget_Large];
    [self addToLibrary:@"menu icon - show both - 40x40" index:ImageIcon_ShowBoth_Large];
    [self addToLibrary:@"menu icon - follow me - 40x40" index:ImageIcon_FollowMe_Large];
    [self addToLibrary:@"menu icon - find me - 40x40" index:ImageIcon_FindMe_Large];
    [self addToLibrary:@"menu icon - find target - 40x40" index:ImageIcon_FindTarget_Large];
    [self addToLibrary:@"menu icon - gnss-on - 40x40" index:ImageIcon_GNSSOn_Large];
    [self addToLibrary:@"menu icon - gnss-off - 40x40" index:ImageIcon_GNSSOff_Large];
